...
const PHASES = [
  {
    ...
    steps: [
      ...
      'Surface DRG delta: e.g. AED 31K → AED 61K if AKI documented',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Track revenue delta in real time: e.g. +AED 15,400 from new CC/MCC',
    ],
      ...
      <div className="wrap" style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          {[
            ...
            { val: 'AED 370M+', label: 'Revenue recovered', color: '#4d8aff' },
