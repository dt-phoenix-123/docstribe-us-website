...
const UAE_DEMO_SCENES = [
  {
    ...
    voText: 'In UAE hospitals, twelve to eighteen percent of claims are denied first-pass — sixty to seventy percent preventably. Not clinical failures. Documentation gaps. That\'s where revenue disappears. Docstribe closes it before it opens.',
  },
  {
    id: 2, timecode: '0:12–0:28', journeyStage: 'outcomes',
    title: 'Outcomes Upfront — The KPI Promise',
    voText: 'Docstribe is a skilled AI agentic workforce — purpose-built for UAE. It listens to every clinical and financial signal, and acts in real time. Sixty days from go-live, guaranteed: thirty percent fewer denials. Twenty-five percent more revenue. CMI up zero point fifteen.',
  },
  {
    id: 3, timecode: '0:28–0:38', journeyStage: 'platform',
    title: 'One Unified Workspace',
    voText: 'OPD, IPD, emergency — one workspace. Clinical and financial context, same view. Every encounter tracked from first appointment to final payment. Nothing falls through.',
  },
  {
    id: 4, timecode: '0:38–0:48', journeyStage: 'pre-visit',
    title: 'Pre-Visit — Eligibility & Pre-Auth',
    voText: 'Eligibility confirmed. Pre-auth triggered at order entry — not at discharge. Approved before the patient arrives. Zero write-offs.',
  },
  {
    id: 5, timecode: '0:48–0:58', journeyStage: 'in-visit',
    title: 'Ambient Clinical Intelligence',
    voText: 'Every encounter — one structured note. ICD-10-CM coded, NABIDH compliant, DHA licensed. Physicians stay in care. Documentation done.',
  },
  {
    id: 6, timecode: '0:58–1:08', journeyStage: 'cdi',
    title: 'CDI — Closing the Gap',
    voText: 'Medical necessity confirmed OPD — one tap. IR-DRG gap closed IPD before discharge. E-signed. DHA-defensible.',
  },
  {
    id: 7, timecode: '1:08–1:20', journeyStage: 'coding',
    title: 'AI-Powered Coding',
    voText: 'Notes to ICD-10-CM codes — instantly. IR-DRG weight from zero point nine four to one point three four. AED eighteen thousand four hundred recovered per case.',
  },
  {
    id: 8, timecode: '1:20–1:30', journeyStage: 'denial-intel',
    title: 'Denial Intelligence',
    voText: 'Claims scored pre-submission. Four denial drivers flagged. AED two hundred fourteen thousand surfaced. Denial rate down thirty percent — prevention, not appeals.',
  },
  {
    id: 9, timecode: '1:30–1:38', journeyStage: 'recovery',
    title: 'One-Click Recovery',
    voText: 'Denial arrives. One click — contract appeal ready. Policy terms cited. Three weeks to thirty seconds.',
  },
  {
    id: 10, timecode: '1:38–1:50', journeyStage: 'pathway',
    title: '30-Day Revenue Pipeline',
    voText: 'Live thirty-day revenue forecast — clinical signals, not averages. AED one point four million. Predicted at admission, not month end.',
  },
  {
    id: 11, timecode: '1:50–2:05', journeyStage: 'dashboard',
    title: 'One Platform. Zero Leakage.',
    voText: 'Thirty percent fewer denials. Twenty-five percent more revenue. CMI up zero point fifteen. Zero leakage — contractually guaranteed within sixty days of go-live. One platform. Docstribe.',
  },
];
